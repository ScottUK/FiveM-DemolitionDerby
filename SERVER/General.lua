        ...
        elseif PlayerIndices > 0 then
            ...
            elseif not AdminTestMode then
                ...
                elseif GameStarted and not GameRunning then
                    ...
                    while Waiting do
                        Citizen.Wait(250)
                        if (#ReadyPlayers == #LivingPlayers) or ((GetGameTimer() - Timer) >= 10000) or PlayerIndices ==
                            0 then
                            Waiting = false
                        end
                ...
                elseif GameStarted and GameRunning then
                    if (PlayerIndices > 1 and #SpawnedPlayers == 1) or (#DiedPlayers == #SpawnedPlayers) or
                        (PlayerIndices > 1 and #SpawnedPlayers - #DiedPlayers == 1) then
